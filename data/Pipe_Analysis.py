...
def processData(Size,Length, Classification ):
    ...
    values={"Size":Size.replace("_","/")+'"',"Length":Length,"Classification":Classification}
...
if __name__ == "__main__":
    ...
    args = sys.argv
    print (processData(args[0], args[1], args[2]))